 ...
 */
export const deleteThresholdApiV1AdminModerationThresholdsAgeBandCategoryDelete = <ThrowOnError extends boolean = false>(options: Options<DeleteThresholdApiV1AdminModerationThresholdsAgeBandCategoryDeleteData, ThrowOnError>): RequestResult<DeleteThresholdApiV1AdminModerationThresholdsAgeBandCategoryDeleteResponses, DeleteThresholdApiV1AdminModerationThresholdsAgeBandCategoryDeleteErrors, ThrowOnError> => (options.client ?? client).delete<DeleteThresholdApiV1AdminModerationThresholdsAgeBandCategoryDeleteResponses, DeleteThresholdApiV1AdminModerationThresholdsAgeBandCategoryDeleteErrors, ThrowOnError>({
    responseType: 'json',
 ...
 * ValidationError: If ``age_band`` is not a known band (422).
 */
export const upsertThresholdApiV1AdminModerationThresholdsAgeBandCategoryPut = <ThrowOnError extends boolean = false>(options: Options<UpsertThresholdApiV1AdminModerationThresholdsAgeBandCategoryPutData, ThrowOnError>): RequestResult<UpsertThresholdApiV1AdminModerationThresholdsAgeBandCategoryPutResponses, UpsertThresholdApiV1AdminModerationThresholdsAgeBandCategoryPutErrors, ThrowOnError> => (options.client ?? client).put<UpsertThresholdApiV1AdminModerationThresholdsAgeBandCategoryPutResponses, UpsertThresholdApiV1AdminModerationThresholdsAgeBandCategoryPutErrors, ThrowOnError>({
    responseType: 'json',
    url: '/api/v1/admin/moderation-thresholds/{age_band}/{category}',
    ...options,
    headers: {
