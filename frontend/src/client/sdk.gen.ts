 ...
 */
export const recallStorybookApiV1StorybooksStorybookIdRecallPost = <ThrowOnError extends boolean = false>(options: Options<RecallStorybookApiV1StorybooksStorybookIdRecallPostData, ThrowOnError>): RequestResult<RecallStorybookApiV1StorybooksStorybookIdRecallPostResponses, RecallStorybookApiV1StorybooksStorybookIdRecallPostErrors, ThrowOnError> => (options.client ?? client).post<RecallStorybookApiV1StorybooksStorybookIdRecallPostResponses, RecallStorybookApiV1StorybooksStorybookIdRecallPostErrors, ThrowOnError>({
    responseType: 'json',
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 * AuthorizationError: If the caller is not an admin (-> 403).
 */
export const getOutstandingDecisionsApiV1AdminOutstandingDecisionsGet = <ThrowOnError extends boolean = false>(options?: Options<GetOutstandingDecisionsApiV1AdminOutstandingDecisionsGetData, ThrowOnError>): RequestResult<GetOutstandingDecisionsApiV1AdminOutstandingDecisionsGetResponses, GetOutstandingDecisionsApiV1AdminOutstandingDecisionsGetErrors, ThrowOnError> => (options?.client ?? client).get<GetOutstandingDecisionsApiV1AdminOutstandingDecisionsGetResponses, GetOutstandingDecisionsApiV1AdminOutstandingDecisionsGetErrors, ThrowOnError>({
    responseType: 'json',
    security: [{ scheme: 'bearer', type: 'http' }],
