...
def main():
    ...
    parser.add_argument(
        "--project-key",
        default="williaby_cyo_adventure",
        help="SonarQube project key (default: williaby_cyo_adventure)",
    )
    parser.add_argument(
        "--token",
    ...
    parser.add_argument(
        "--org",
        default=os.environ.get("SONAR_ORG", "williaby"),
        help="SonarQube organization (default: williaby)",
    )
    parser.add_argument(
