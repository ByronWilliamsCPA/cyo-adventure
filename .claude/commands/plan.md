...
You are generating the initial project planning documents for CYO Adventure.
...
Review this [Document Type] for CYO Adventure.
...
- **Project Name**: CYO Adventure
- **Package**: cyo_adventure
- **Python Version**: 3.12
