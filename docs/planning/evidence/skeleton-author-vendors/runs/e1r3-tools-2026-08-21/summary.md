...
Primary endpoint (S-1): between-leg statistic 0.000, p = 1.0000 (10000 permutations, seed 20260821). Everything below is exploratory.

| leg | shells | errors | strict pass | first-pass clean | mean repair rounds | output tokens | min catalog distance |
| --- | --- | --- | --- | --- | --- | --- | --- |
| claude-fable-subagent | 3 | 0 | 3 | 3 | 0.00 | 0 | 0.066 |
