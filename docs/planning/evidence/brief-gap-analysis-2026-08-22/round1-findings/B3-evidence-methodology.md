...
`authoring-lessons-log.md` (`AL-509`..`AL-513`), `unscheduled-work-register.md`
...
- *"`AL-509`..`AL-513` / `UW-C317`..`UW-C320` do not exist"* — **retracted.** All eight exist and are
  substantive.
...
- **How to check I'm right**: register D-7b row including both correction boxes; `ls docs/planning/evidence/d7c-binding-notes/` → rig only, no fills; `grep "| AL-509 |" docs/planning/authoring-lessons-log.md`.
