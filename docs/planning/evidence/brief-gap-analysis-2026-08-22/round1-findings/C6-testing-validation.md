...
non-existent artifacts (`S-0`..`S-5`, `AL-509`..`AL-513`, `UW-C317`..`UW-C320`,
...
- **Problem**: The contract, per `CLAUDE.md` and the checker's own docstring, is that
  ...
  Demonstrated on the live tree. I took `AL-513` (open; the PL-18 topology-trap lesson
  ...
  citation of `AL-510` with a dangling id produced
  `FAIL ... lesson 'AL-510' status is not applied/rejected/superseded and is not cited by
...
- **Problem**: I attempted to establish reproducibility for S-1 concretely. The
  ...
  - **No prompt, and the prompt is not stable.** `_author_prompt` composes the user
    ...
    `AL-513` proposes changing the PL-18 message and `UW-C306` the brief-side topology
