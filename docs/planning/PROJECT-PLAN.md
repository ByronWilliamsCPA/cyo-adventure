...
| Plan item | Deliverable | Notes |
|-----------|-------------|-------|
| P7-01 | Apple Developer Program enrollment + EU DSA trader status | Prerequisite for P6-05, TestFlight, and submission; publish trader contact details; **audit 2026-07-20**: enrollment type decided as Individual (no separate legal entity for CYO Adventure); the App Store Seller name will show the owner's personal legal name, not a company name; Small Business Program (15% commission) eligibility is unaffected by this choice and stays a separate post-enrollment application |
