...
| S9 delivery infra (push transport closed 2026-07-28: SSE stream shipped; scheduled digest job remains open), G9 visibility, K12 kid generation status, G7 budget consent + G13 interim quota balance. G10 digest/alerts closed 2026-07-28: SSE push transport shipped, register flipped to ✅ | 4c |
