...
- `cyo_adventure/path/to/file.ext`
...
`cyo_adventure/.github/workflows/`.

**Affected Files**:
- `cyo_adventure/.github/workflows/ci.yml`
- `cyo_adventure/.github/workflows/release.yml`
- `cyo_adventure/.github/workflows/docs.yml`
