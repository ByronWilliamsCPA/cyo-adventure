"""Example tests demonstrating best practices for CYO Adventure.
...
class TestCLI:
    ...
    def test_cli_has_version(self) -> None:
        ...
        """
        from cyo_adventure.cli import cli
    ...
    def test_cli_config_command(self) -> None:
        ...
        assert "Project: CYO Adventure" in result.output
    ...
    def test_cli_context_setup(self) -> None:
        ...
        assert result.exit_code == 0
        assert "CYO Adventure" in result.output
    ...
    def test_cli_hello_error_handling(self) -> None:
        ...
        with patch("cyo_adventure.cli.logger") as mock_logger:
...
class TestExampleIntegration:
    ...
    def test_package_imports(self) -> None:
        ...
        assert hasattr(cyo_adventure, "__version__")

        # Test importing from submodules
        from cyo_adventure.utils import get_logger
